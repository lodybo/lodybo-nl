...
export default function Header() {
  return (
    <div className="w-full relative pb-6">
      <div className="w-full relative flex flex-col md:flex-row gap-10 md:gap-5 h-full">
        <img
      ...
      <p className="absolute bottom-0 right-2.5 text-nord-0 dark:text-nord-6 text-xs sm:text-small">
        Photo by{' '}
