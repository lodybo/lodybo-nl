export const HTML = () => (
  <svg width="100%" preserveAspectRatio="true" viewBox="0 0 512 512">
    <switch>
      <g>
        <g>
          <polygon
          ...
          <g>
            <polygon
              className="dark:fill-nord-polarnight-2-700 fill-nord-polarnight-2-200"
          ...
          <g className="dark:fill-nord-polarnight-0-200 fill-nord-polarnight-0-900">
